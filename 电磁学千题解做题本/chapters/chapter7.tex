...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_2_1.jpg}
\end{center}
\textit{图7.2(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_2_2.jpg}
\end{center}
\textit{图7.2(2)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_2_3.jpg}
\end{center}
\textit{图7.2(3)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_3.jpg}
\end{center}
\textit{图7.3}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_4.jpg}
\end{center}
\textit{图7.4}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_5_1.jpg}
\end{center}
\textit{图7.5}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_5_2.jpg}
\end{center}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_5_3.jpg}
\end{center}
\textit{图7.5(3)}

\vfill

\textbf{7.6.} 用5号吕臬古做的圆柱形磁铁，直径为 $10\mathrm{mm}$ ，长为 $100\mathrm{mm}$ ，均匀磁化后磁极化强度为 $1.2\mathrm{Wb / m^2}$ 。试求：(1)它两端的磁极强度 $q_{\mathrm{m}}$ ；(2)它的磁矩 $m$ 和磁偶极矩 $p_{\mathrm{m}}$ ；(3)当它放在磁感强度为 $\vec{B}$ 的外磁场中， $\vec{B}$ 与它垂直， $B = 10\mathrm{Gs}$ 时，它所受的力矩；(4)已知该磁铁的矫顽力为 $H_{\mathrm{C}} = 4.4\times 10^{4}\mathrm{A / m}$ ，上述外磁场的 $\vec{H}$ 的大小与 $H_{\mathrm{C}}$ 之比。

\vfill

\newpage
\textbf{7.7.} 一磁铁棒长 $5.0\mathrm{cm}$ , 横截面积为 $1.0\mathrm{cm}^2$ , 密度为 $7.9\mathrm{g/cm}^3$ . 设棒内所有铁原子的磁矩都沿棒长方向整齐排列, 每个铁原子的磁矩为 $1.8 \times 10^{-23}\mathrm{A} \cdot \mathrm{m}^2$ . 已知铁的原子量为 55.85, 阿伏伽德罗常量为 $6.022 \times 10^{23}(\mathrm{mol})^{-1}$ . (1) 试求这铁磁棒的磁矩和磁偶极矩; (2) 当这铁磁棒处在 $B = 1.5\mathrm{T}$ 的外磁场中并与 $\vec{B}$ 垂直时, $\vec{B}$ 使它转动的力矩有多大?
...
\newpage
\textbf{7.9.} 真空中有一磁棒长为 $l$ ，磁极强度为 $q_{\mathrm{m}}$ ，试证明：它在很远处产生的磁感强度 $\vec{B}$ 的分量为

$$
B _ {r} = \frac {q _ {\mathrm{m}} l \cos \theta}{2 \pi r ^ {3}}, \quad B _ {\theta} = \frac {q _ {\mathrm{m}} l \sin \theta}{4 \pi r ^ {3}}
$$

式中 $r(\gg l)$ 是棒中心到场点 $P$ 的距离， $\theta$ 是 $r$ 与棒长之间的夹角[图7.9(1)]， $B_r$ 和 $B_\theta$ 分别是 $\vec{B}$ 在 $\vec{r}$ 方向上和 $\theta$ 方向上的分量.



\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_9_1.jpg}
\end{center}
\textit{图7.9(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_9_2.jpg}
\end{center}
\textit{图7.9(2)}
...
式中 $r(r \gg \sqrt{S})$ 是线圈中心到场点 $P$ 的距离, $\theta$ 是 $r$ 与线圈平面的法线之间的夹角(图7.10), $B_r$ 和 $B_\theta$ 分别是 $\vec{B}$ 在 $\vec{r}$ 方向上和 $\theta$ 方向上的分量.[提示:与前面7.9题对比]

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_10.jpg}
\end{center}
\textit{图7.10}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_11_1.jpg}
\end{center}
\textit{图7.11}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_11_2.jpg}
\end{center}
...
\newpage
\textbf{7.13.} (1) 半径为 $R$ 的圆线圈载有电流 $I$ , 试求它在磁感强度为 $\vec{B}$ 的均匀外磁场中所受的力矩 $\vec{M}$ ; (2) 半径为 $R$ 的圆磁片(磁壳), 厚为 $l$ , 两面均匀分布着磁荷, 磁荷量的面密度分别为 $\sigma_{\mathrm{m}}$ 和 $-\sigma_{\mathrm{m}}$ , 试求它在磁感强度为 $\vec{B}$ 的均匀外磁场中所受的力矩 $\vec{M}'$ ; (3) 若 $\vec{M}' = \vec{M}$ , 则圆磁片就叫做圆电流的等效磁壳. 试求圆电流与它的等效磁壳的关系.
...
$$
\mathrm{d} \vec{H} = \frac {1}{4 \pi \mu_ {0}} \frac {\mathrm{d} q _ {\mathrm{m}}}{r ^ {3}} \vec{r}, \quad \mathrm{d} U _ {\mathrm{m}} = \frac {1}{4 \pi \mu_ {0}} \frac {\mathrm{d} q _ {\mathrm{m}}}{r}
$$
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_14_1.jpg}
\end{center}
\textit{图7.14}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_14_2.jpg}
\end{center}
\textit{图 7.14}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_15_1.jpg}
\end{center}
\textit{图7.15(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_15_2.jpg}
\end{center}
\textit{图7.15(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_16_1.jpg}
\end{center}
\textit{图 7.16(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_16_2.jpg}
\end{center}
\textit{图 7.16(2)}
...
\textbf{7.18.} 一无限长圆柱形直铜线, 横截面的半径为 $R$ , 线外包有一层相对磁导率为 $\mu_r$ 的均匀磁介质, 层厚为 $d$ , 导线中通有电流 $I, I$ 均匀分布在横截面上. 试求: (1) 离轴线为 $r$ 处的磁场强度 $\vec{H}$ 和磁感强度 $\vec{B}$ 的大小; (2) 磁介质内、外表面上的磁化电流.
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_21.jpg}
\end{center}
\textit{图7.21}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_22.jpg}
\end{center}
\textit{图7.22}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_23_1.jpg}
\end{center}
\textit{图7.23(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_23_2.jpg}
\end{center}
\textit{图7.23(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_25_1.jpg}
\end{center}
\textit{图7.25(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_25_2.jpg}
\end{center}
\textit{图7.25(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_28.jpg}
\end{center}
\textit{图7.28}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_37.jpg}
\end{center}
\textit{图7.37}
...
\textbf{7.40.} 一磁偶极子的磁偶极矩为 $p_{\mathrm{m}}$ ，处在磁场强度为 $\vec{H}$ 的非均匀外磁场中， $p_{\mathrm{m}}$ 与 $\vec{H}$ 平行或逆平行。（1）试证明，它受磁场 $\vec{H}$ 的作用力 $f$ 的大小为 $f = p_{\mathrm{m}}\left|\frac{\partial H}{\partial l}\right|$ ，式中 $\frac{\partial H}{\partial l}$ 是 $\vec{H}$ 的大小沿 $p_{\mathrm{m}}$ 方向的微商；(2) $f$ 的方向如何？
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_41.jpg}
\end{center}
\textit{图 7.41}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_43_1.jpg}
\end{center}
\textit{图7.43}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_43_2.jpg}
\end{center}
\textit{图7.43(1)}
...
$$
\vec{B} = \frac {\mu_ {0}}{4 \pi r ^ {3}} \left[ \frac {3 (\vec{m} \cdot \vec{r}) \vec{r}}{r ^ {2}} - \vec{m} \right]
$$

另一圆电流 I, 半径为 a, 中心在 $(0,0,b)$ 处, 其轴线与 z 轴重合, 如图 7.44 所示. 试求它们之间的相互作用力.

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_44_1.jpg}
\end{center}
\textit{图7.44}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_44_2.jpg}
\end{center}
\textit{图7.44(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_45.jpg}
\end{center}
\textit{图7.45}
...
\newpage
\textbf{7.47.} 磁偶极矩分别为 $p_1$ 和 $p_2$ 的两个小磁针固定在一起，中心重合， $p_1$ 与 $p_2$ 的夹角为 $\theta = \theta_1 + \theta_2$ ，用细线拴住它们的重心，悬挂着使它们处在水平面内并可以自由转动。加上一个水平的均匀外磁场 $\vec{B}$ ，当它们达到静止时， $p_1$ 和 $p_2$ 与 $\vec{B}$ 的夹角分别为 $\theta_1$ 和 $\theta_2$ ，如图7.47(1)所示（图面是水平面）。试证明： $\frac{\sin\theta_1}{p_2} = \frac{\sin\theta_2}{p_1} = \frac{\sin\theta}{\sqrt{p_1^2 + p_2^2 + 2p_1p_2\cos\theta}}$


\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_7_47.jpg}
\end{center}
\textit{图7.47(1)}
