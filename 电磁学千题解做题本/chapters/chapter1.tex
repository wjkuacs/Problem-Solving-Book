\textbf{1.1.1.} 电荷量分别为 $q_{1}$ 和 $q_{2}$ 的两个静止的点电荷，相距为 $r$ ，试求下列情况下它们之间的相互作用力，即 $q_{1}$ 作用在 $q_{2}$ 上的力 $\vec{F}_{21}$ 和 $q_{2}$ 作用在 $q_{1}$ 上的力 $\vec{F}_{12}$ :(1) $q_{1}$ 和 $q_{2}$ 都在真空中；(2) $q_{1}$ 和 $q_{2}$ 都在均匀介质中；(3) $q_{2}$ 在导体空腔内， $q_{1}$ 则在导体外.
...
\begin{center}
    \includegraphics[width=0.15\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_5_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.15\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_6_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_7.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.2\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_8.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_9.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.2\linewidth,height=0.2\textheight,keepaspectratio]{figures/fig_1_1_10_1.jpg}
\end{center}

\vfill

\newpage
\textbf{1.1.11.} 两个固定的点电荷, 电荷量都是 $Q$ , 相距为 $l$ , 联线中点为 $O$ ; 另一点电荷, 电荷量为 $q$ , 在联线的中垂面上距离 $O$ 为 $r$ 处, 如图 1.1.11 所示. (1) 求 $q$ 受的力; (2) 若开始时 $q$ 是静止的, 然后让它自己运动, 问它将如何运动？试分别就 q 与 Q 同号和异号两种情况加以讨论.

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_11.jpg}
\end{center}
\vfill

\textbf{1.1.12.} 卢瑟福实验证明: 当两个原子核之间的距离小到 $10^{-15}$ m 时, 它们之间的排斥力仍遵守库仑定律. 金的原子核中有 79 个质子, 氦的原子核(即 $\alpha$ 粒子)中有2个质子.已知每个质子的电荷量为 $1.60\times10^{-19}C,\alpha$ 粒子的质量为 $6.68\times10^{-27}kg$ .当 $\alpha$ 粒子与金核相距为 $6.9\times10^{-15}m$ 时,设它们都可当作点电荷,试求金核作用在 $\alpha$ 粒子上的库仑力和 $\alpha$ 粒子因此而产生的加速度.
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_17.jpg}
\end{center}
\vfill
...
\begin{center}
    \includegraphics[width=0.2\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_19.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_1_20.jpg}
\end{center}
...
\textbf{1.2.3.} 两个点电荷, 电荷量分别为 $q_{1} = 8.0\mu \mathrm{C}$ , $q_{2} = -16.0\mu \mathrm{C}$ , 相距 $20\mathrm{cm}$ . 试求这两个电荷在离它们都是 $20\mathrm{cm}$ 处产生的电场强度 $\vec{E}$ .

\begin{center}
    \includegraphics[width=0.16\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_3.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_4.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_5_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.2\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_6_1.jpg}
\end{center}

\vfill

\textbf{1.2.7.} 相距为 $l$ 的两个点电荷, 电荷量分别为 $q$ 和 $-q$ , 以它们的联线为 $x$ 轴, 联线的中点为原点, 取笛卡儿坐标系如图 1.2.7(1) 所示. (1) $P(x, y)$ 为 $x, y$ 平面上任一点, 试求它们在 $P$ 点产生的电场强度 $\vec{E}$ ; (2) 对于 $r \gg l$ 的区域来说, 这两个电荷构成的系统称为电偶极子. 试求电偶极子在 $P$ 点产生的电场强度.



\begin{center}
    \includegraphics[width=0.2\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_7_1.jpg}
\end{center}

\vfill

\newpage
\textbf{1.2.8.} 一电偶极子的电偶极矩为 $p = ql$ ，以它的中心 $O$ 为原点，沿 $l$ 取极轴或 $x$ 轴，如图1.2.8(1)所示。 $P$ 为空间任一点，其位矢为 $r$ 。以 $l$ 和 $r$ 构成的平面为 $x - y$ 平面。试证明： $p$ 在 $P$ 点产生的电场强度 $E$ ，

(1)用极坐标表示为
$$
\vec{E} = \frac {1}{4 \pi \varepsilon_ {0} r ^ {3}} \left[ \frac {3 (\vec{p} \cdot \vec{r})}{r ^ {2}} \vec{r} - \vec{p} \right]
$$

(2)用笛卡儿坐标表示为
$$
\vec{E} = \frac {p}{4 \pi \varepsilon_ {0} (x ^ {2} + y ^ {2}) ^ {5 / 2}} [ (2 x ^ {2} - y ^ {2}) \hat{i} + 3 x y \hat{j} ]
$$



\begin{center}
    \includegraphics[width=0.2\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_8_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.2\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_9_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_10.jpg}
\end{center}

\vfill

\textbf{1.2.11.} 四个点电荷分别处在一个边长为 $l$ 的正方形的四个角上，它们的电荷量分别为 $-q, q, -q$ 和 $q$ ，如图1.2.11(1)所示。 $P$ 是与正方形在同一平面内的一点， $P$ 到正方形中心 $O$ 的距离为 $r$ ，且 $OP$ 联线平行于正方形的两边。(1)试求四个电荷在 $P$ 点产生的电场强度；(2)对于 $r \gg l$ 的区域来说，这四个电荷构成的系统称为平面电四极子. 试求这平面电四极子在 $P$ 点产生的电场强度.

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_11_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_12_1.jpg}
\end{center}
...
\textbf{1.2.16.} 电荷量 q 均匀分布在半径为 R 的圆环上。(1)试求这电荷在轴线上离环心为 r 处的电场强度 E;(2)画出 E-r 曲线(即以 r 为横坐标,以 E 的大小 E 为纵坐标的 E 与 r 的关系曲线);(3)轴线上什么地方 E 最大? 其值是多少?(4)试证明: 当 $r \gg R$ 时, E 趋于 q 集中在环心所产生的电场强度.

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_16_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_17.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_19_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_20_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_22_1.jpg}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_22_2.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_24.jpg}
\end{center}
...
\newpage
\textbf{1.2.29.} 电荷分布在半径为 R 的球面上, 电荷量的面密度为 $\sigma = a \cdot R$ , 式中 a 是一个常矢量，R 是球心到球面上一点的矢径. 试证明：球内电场是均匀电场.
...
\begin{center}
    \includegraphics[width=0.2\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_30_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_31.jpg}
\end{center}
\vfill

\textbf{1.2.32.} 电荷分布在半径为 R 的球体内, 电荷量的密度为 $\rho = a \cdot r$ , 式中 a 是常矢量，r 是从球心到球内一点的矢径. 试求球心的电场强度.


\vfill

\newpage
\textbf{1.2.33.} 用长为 $l$ 的细丝线系一个质量为 $m$ 的小球, 作成单摆, 如图 1.2.33 (1). 令小球带电荷量 $q$ 后, 放在一个匀强电场 $\vec{E}$ 中, $\vec{E}$ 的方向在竖直方向. (1) 试分别求 $\vec{E}$ 向下和向上时, 这单摆的周期; (2) 在什么情况下周期比不带电时长?

\begin{center}
    \includegraphics[width=0.15\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_33_1.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.1\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_34_1.jpg}
\end{center}

\vfill

\newpage
\textbf{1.2.35.} 把电偶极矩为 $p = ql$ 的电偶极子放在电荷量为 $Q$ 的点电荷的电场里， $p$ 的中心点 $O$ 到 $Q$ 的距离为 $r$ . 试分别求下列情况下它所受的力 $\vec{F}$ 和力矩 $\vec{M}: (1)p \parallel Q\vec{O}; (2)p \perp Q\vec{O}$ .

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_35_1.jpg}
\end{center}

\vfill

\textbf{1.2.36.} 电偶极矩为 $\vec{p}$ 的电偶极子,处在电场强度为 $\vec{E}$ 的外电场中,$\vec{p}$ 与 $\vec{E}$ 的夹角为 $\theta$ ,如图 1.2.36 所示.

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_36.jpg}
\end{center}
(1)如果 $\vec{E}$ 是均匀电场, $\theta$ 为什么值时 $\vec{p}$ 达到平衡?是稳定平衡还是不稳定平衡?

(2)如果 $\vec{E}$ 不是均匀电场，试求 $\vec{p}$ 所受的力的公式.


\vfill

\newpage
\textbf{1.2.37.} 电偶极矩为 $p$ 的电偶极子处在电场强度为 $\vec{E}$ 的均匀外电场中，当 $p$ 平行于 $\vec{E}$ 时达到平衡。如果让 $p$ 稍微偏离 $\vec{E}$ 的方向，然后放手，则在 $\vec{E}$ 的作用下，它便会作微小振动。已知它作这种振动的转动惯量为 $I$ ，试求振动频率。
...
\begin{center}
    \includegraphics[width=0.15\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_38_1.jpg}
\end{center}
\vfill
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_39_1.jpg}
\end{center}
\textit{图1.2.39(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_39_2.jpg}
\end{center}
\textit{图1.2.39(2)}
...
\newpage
\textbf{1.2.41.} 质量为 $m$ 、电荷量为 $q$ 的粒子在电场强度为 $\vec{E}$ 的均匀电场中运动，开始 $(t = 0)$ 时位矢为 $\vec{r}_0$ ，速度为 $\vec{v}_0$ ，试证明， $t$ 时刻它的位矢为 $\vec{r} = \frac{q}{2m} Et^2 +\vec{v}_0t + \vec{r}_0.$
...
$$
\frac {\mathrm{d}}{\mathrm{d} t} \left(\frac {m \vec{v}}{\sqrt {1 - \frac {v ^ {2}}{c ^ {2}}}}\right) = q \vec{E}
$$

式中 $\vec{v}$ 是粒子的速度， $c$ 是真空中光速。设以出发点为原点，沿 $\vec{E}$ 的方向取 $x$ 轴，则 $v = \frac{\mathrm{d}x}{\mathrm{d}t}$ 。(1)试求粒子的坐标 $x$ 与时间 $t$ 的关系；(2)试证明，当 $t \to \infty$ 时，粒子的速度趋于 $c$ ；(3)试验证，当 $\frac{qE}{mc} t \ll 1$ 时，所得结果趋于非相对论的情况。

\vfill

\newpage
\textbf{1.2.43.} 一示波管用电场使电子偏转,如图 1.2.43 所示,偏转电极长为 l=电场使电子偏转,如图 1.2.43 所示,偏转电极长为 $l = 1.5 \mathrm{~cm}$ ,两极间是均匀电场,电场强度 $\vec{E}$ 的大小为 $E = 1.2 \times 10^{4} \mathrm{~V} / \mathrm{m}$ .一电子以初速度 $\vec{v}_{0}$ 进入这个电场, $\vec{v}_{0}$ 与 $\vec{E}$ 垂直.已知电子质量为 $m = 9.1 \times 10^{-31} \mathrm{~kg}$ ,电荷量的大小为 $e = 1.6 \times 10^{-19} \mathrm{C}$ ,初速度为 $\vec{v}_{0} = 2.6 \times 10^{7} \mathrm{~m} / \mathrm{s}$ ,试求电子经过电极所发生的偏转 $y$ .


\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_43.jpg}
\end{center}
\textit{图1.2.43}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_45_1.jpg}
\end{center}
\textit{图1.2.45(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_45_2.jpg}
\end{center}
\textit{图1.2.45(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_48_1.jpg}
\end{center}
\textit{图1.2.48}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_48_2.jpg}
\end{center}
\textit{图1.2.48(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_49_1.jpg}
\end{center}
\textit{图1.2.49(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_2_49_2.jpg}
\end{center}
\textit{图1.2.49(2)}

\vfill

\textbf{1.3.1.} 高斯定理的表达式为 $\oiint_{S} \vec{E} \cdot \mathrm{d}\vec{S} = \frac{1}{\varepsilon_0} Q$ 。为什么此式左边的 $E$ 是高斯面 $S$ 内外所有电荷产生的电场强度，而右边的 $Q$ 却只是 $S$ 内的电荷而不包括 $S$ 外的电荷呢？
...
\textbf{1.3.5.} 电荷 $Q_{1}$ 均匀分布在半径为 $R_{1}$ 的球面上，电荷 $Q_{2}$ 均匀分布在半径为 $R_{2}$ 的同心球面上，如图1.3.5所示.(1)试求离球心为 $r$ 处的电场强度 $\vec{E}$ ;(2)当 $Q_{2} = -Q_{1}$ 时各处的 $\vec{E}$ 如何？

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_5.jpg}
\end{center}
\textit{图1.3.5}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_6.jpg}
\end{center}
\textit{图1.3.6}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_7_1.jpg}
\end{center}
\textit{图1.3.7(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_7_2.jpg}
\end{center}
\textit{图1.3.7(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_8.jpg}
\end{center}
\textit{图1.3.8}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_10_1.jpg}
\end{center}
\textit{图1.3.10(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_10_2.jpg}
\end{center}
\textit{图1.3.10(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_11.jpg}
\end{center}
\textit{图1.3.11}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_12.jpg}
\end{center}
\textit{图1.3.12}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_13.jpg}
\end{center}
\textit{图1.3.13}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_14.jpg}
\end{center}
\textit{图1.3.14}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_20.jpg}
\end{center}
\textit{图1.3.20}

\vfill

\textbf{1.3.21.} 半径为 $a$ 的无穷长直圆筒面均匀带电，沿轴线单位长度的电荷量为 $\eta$ 。试求离轴线为 $r$ 处的电场强度 $\vec{E}$ ，并画出 $E - r$ 曲线（即以 $r$ 为横坐标，以 $\vec{E}$ 的大小 $E$ 为纵坐标的 $E$ 与 $r$ 的关系曲线）。

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_21.jpg}
\end{center}
\textit{图1.3.21}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_22.jpg}
\end{center}
\textit{图1.3.22}
...
$\rho$ .试求离轴线为 $r$ 处的电场强度 $\vec{E}$ ，并画出 $E - r$ 曲线.


\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_23.jpg}
\end{center}
\textit{图1.3.23}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_24.jpg}
\end{center}
\textit{图1.3.24}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_26.jpg}
\end{center}
\textit{图1.3.26}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_27.jpg}
\end{center}
\textit{图1.3.27}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_28.jpg}
\end{center}
\textit{图1.3.28}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_29.jpg}
\end{center}
\textit{图1.3.29}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_30_1.jpg}
\end{center}
\textit{图1.3.30(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_30_2.jpg}
\end{center}
\textit{图 1.3.30(2)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_30_3.jpg}
\end{center}
\textit{图1.3.30(3)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_30_4.jpg}
\end{center}
\textit{图1.3.30(4)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_3_31.jpg}
\end{center}
\textit{图1.3.31}
...
\textbf{1.4.4.} 有人说：“在静电情况下，空间某一点的电势 $U$ 已定，该点电场强度 $\vec{E}$ 的大小 $\vec{E}$ 可以是任何值，方向可以是任何方向；反过来，该点的 $\vec{E}$ 已定，该点的电势可以是任何值。因此，空间同一点的 $\vec{E}$ 和 $U$ 没有直接关系。”你认为这种说法怎样？
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_5.jpg}
\end{center}
\textit{图1.4.5}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_11.jpg}
\end{center}
\textit{图1.4.11}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_12.jpg}
\end{center}
\textit{图1.4.12}
...
\newpage
\textbf{1.4.13.} 半径为 $R$ 的光滑绝缘圆环, 固定在光滑绝缘的水平桌面上; 空间有水平方向的均匀电场, 电场强度为 $\vec{E}$ , 如图1.4.13(1)所示, 图中纸面代表水平面. 在圆环内侧有一质量为 $m$ 、带有电荷量 $q$ 的质点, 它从 $P_{1}$ 位置以初速 $\vec{v}_{0}(\vec{v}_{0} \perp \vec{E})$ 出发, 贴着圆环内侧作圆周运动. 为了使这质点经过图中 $P_{2}$ 位置 ( $P_{2}$ 与 $P_{1}$ 在同一直经的两端) 继续贴着圆环运动, 试求 $v_{0}$ 的取值范围.

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_13_1.jpg}
\end{center}
\textit{图1.4.13(2)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_13_2.jpg}
\end{center}
\textit{图1.4.13(2)}

\vfill

\textbf{1.4.14.} 一长为 $l$ 的丝线一端固定在 $O$ 点, 另一端系有质量为 $m$ 、电荷量为 $q (< 0)$ 的小球, 开始时, 丝线处于水平的伸直状态; 空间有电场强度为 $\vec{E}$ 的均匀电场, $\vec{E}$ 沿水平方向, 如图 1.4.14(1) 所示. 然后将小球自静止释放, 让它在重力和电场力的作用下摆动. 设丝线的质量和空气的阻力均可略去不计, $\vec{E}$ 的大小为 $E = mg / |q|$ . (1) 试求 $m$ 第一次到达最低点所需的时间 $t$ ; (2) 设 $m$ 经过最低点后, 丝线一直处于伸直状态, 试求它达到左边水平位置时速度的大小 $v$ .




\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_14_1.jpg}
\end{center}
\textit{图1.4.14(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_14_2.jpg}
\end{center}
\textit{图1.4.14(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_16.jpg}
\end{center}
\textit{图1.4.16}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_21.jpg}
\end{center}
\textit{图1.4.21}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_22.jpg}
\end{center}
\textit{图1.4.22}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_23.jpg}
\end{center}
\textit{图1.4.23}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_24.jpg}
\end{center}
\textit{图1.4.24}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_25_1.jpg}
\end{center}
\textit{图1.4.25}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_25_2.jpg}
\end{center}
\textit{图1.4.25(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_26.jpg}
\end{center}
\textit{图1.4.26}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_27.jpg}
\end{center}
\textit{图1.4.27}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_28.jpg}
\end{center}
\textit{图1.4.28}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_29.jpg}
\end{center}
\textit{图1.4.29}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_30_1.jpg}
\end{center}
\textit{图1.4.30}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_30_2.jpg}
\end{center}
\textit{图1.4.30(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_31.jpg}
\end{center}
\textit{图1.4.31}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_32.jpg}
\end{center}
\textit{图1.4.32}
...
$$
\vec{E} = \frac {3 q l ^ {2}}{4 \pi \varepsilon_ {0} r ^ {4}} \left[ (3 \cos^ {2} \theta - 1) \hat{e}_{r} + 2 \sin \theta \cos \theta \hat{e}_{r} \right]
$$


\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_34.jpg}
\end{center}
\textit{图1.4.34}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_35_1.jpg}
\end{center}
\textit{图1.4.35(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_35_2.jpg}
\end{center}
\textit{图1.4.35(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_36_1.jpg}
\end{center}
\textit{图1.4.36(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_36_2.jpg}
\end{center}
\textit{图1.4.36(2)}
...
\newpage
\textbf{1.4.37.} 电荷量 $q$ 均匀地分布在长为 $2l$ 的一段直线上, 如图 1.4.37(1) 和图 1.4.37(2) 所示, 试求下列各处的电势 $U$ , 并由 $U$ 求电场强度 $\vec{E}$ : (1) 中垂面上离中心 $O$ 为 $r_1$ 处; (2) 延长线上离 $O$ 为 $r_2$ 处; (3) 端垂面 (通过一端并垂直于直线段的平面) 上离该端为 $r_3$ 处.



\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_37_1.jpg}
\end{center}
\textit{图1.4.37(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_37_2.jpg}
\end{center}
\textit{图1.4.37(2)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_37_3.jpg}
\end{center}
\textit{图1.4.37(3)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_39.jpg}
\end{center}
\textit{图1.4.39}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_40.jpg}
\end{center}
\textit{图1.4.40}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_41_1.jpg}
\end{center}
\textit{图1.4.41(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_41_2.jpg}
\end{center}
\textit{图1.4.41(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_42.jpg}
\end{center}
\textit{图1.4.42}
...
为 $r$ 的一点, 如图1.4.43(1)所示. (1)试求 $P$ 点的电势 $U$ , 并由 $U$ 求电场强度 $\vec{E}$ ; (2)试求 $P$ 点的电场强度 $\vec{E}$ , 并由 $\vec{E}$ 求电势 $U$ ; (3)以 $r$ 为横坐标, $U$ 为纵坐标, 画出 $U - r$ 曲线.

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_43_1.jpg}
\end{center}
\textit{图1.4.43(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_43_2.jpg}
\end{center}
\textit{图1.4.43(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_44_1.jpg}
\end{center}
\textit{图1.4.44(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_44_2.jpg}
\end{center}
\textit{图1.4.44(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_45.jpg}
\end{center}
\textit{图1.4.45}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_47_1.jpg}
\end{center}
\textit{图1.4.47(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_47_2.jpg}
\end{center}
\textit{图1.4.47(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_48.jpg}
\end{center}
\textit{图1.4.48}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_49_1.jpg}
\end{center}
\textit{图1.4.49(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_49_2.jpg}
\end{center}
\textit{图1.4.49(2)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_49_3.jpg}
\end{center}
\textit{图1.4.49(3)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_50.jpg}
\end{center}
\textit{图1.4.50}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_53.jpg}
\end{center}
\textit{图1.4.53}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_54.jpg}
\end{center}
\textit{图1.4.54}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_55_1.jpg}
\end{center}
\textit{图1.4.55}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_55_2.jpg}
\end{center}
\textit{图1.4.55(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_56.jpg}
\end{center}
\textit{图1.4.56}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_1_4_57.jpg}
\end{center}
\textit{图1.4.57}
