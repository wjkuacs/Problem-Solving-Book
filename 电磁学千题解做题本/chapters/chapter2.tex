...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_1_1.jpg}
\end{center}
\textit{图 2.1.1}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_1_2.jpg}
\end{center}
\textit{图2.1.1}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_2.jpg}
\end{center}
\textit{图2.1.2}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_3.jpg}
\end{center}
\textit{图2.1.3}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_7.jpg}
\end{center}
\textit{图2.1.7}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_8_1.jpg}
\end{center}
\textit{图2.1.8}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_8_2.jpg}
\end{center}
\textit{图 2.1.8}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_11.jpg}
\end{center}
\textit{图2.1.11}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_12.jpg}
\end{center}
\textit{图2.1.12}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_13.jpg}
\end{center}
\textit{图2.1.13}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_17.jpg}
\end{center}
\textit{图2.1.17}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_18.jpg}
\end{center}
\textit{图2.1.18}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_19.jpg}
\end{center}
\textit{图2.1.19}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_20.jpg}
\end{center}
\textit{图2.1.20(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_21.jpg}
\end{center}
\textit{图2.1.21}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_22.jpg}
\end{center}
\textit{图2.1.22}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_24.jpg}
\end{center}
\textit{图2.1.24}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_25.jpg}
\end{center}
\textit{图2.1.25}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_26.jpg}
\end{center}
\textit{图2.1.26}
...
\textbf{2.1.30.} 内外半径分别为 $R_{2}$ 和 $R_{3}$ 的金属球壳 $B$ 带有电荷量 $Q$ ，在它里面放一个带有电荷量 $q$ 、半径为 $R_{1}$ 的同心金属球 $A$ ，如图2.1.30所示。（1）试求离球心为 $r$ 处的电场强度 $\vec{E}$ 和电势 $U$ 以及球与壳的电势差；(2)试画出 $E - r$ 曲线和 $U - r$ 曲线；(3)当 $q = -Q$ 时各处的 $\vec{E}$ 和 $U$ 如何？


\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_30_1.jpg}
\end{center}
\textit{图2.1.30}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_30_2.jpg}
\end{center}
\textit{图2.1.30(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_30_3.jpg}
\end{center}
\textit{图2.1.30(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_31.jpg}
\end{center}
\textit{图2.1.31}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_32_1.jpg}
\end{center}
\textit{图2.1.32}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_32_2.jpg}
\end{center}
\textit{图2.1.32(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_32_3.jpg}
\end{center}
\textit{图2.1.32(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_33.jpg}
\end{center}
\textit{图2.1.33}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_34.jpg}
\end{center}
\textit{图2.1.34}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_36.jpg}
\end{center}
...
近 $\sigma$ 处，电场强度为 $E = \frac{\sigma}{\varepsilon_0}\vec{n}$ ，式中 $\vec{n}$ 是 $\sigma$ 处导体外法线方向上的单位矢量。

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_37.jpg}
\end{center}
\textit{图2.1.37}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_38.jpg}
\end{center}
\textit{图2.1.38}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_43_1.jpg}
\end{center}
\textit{图2.1.43}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_43_2.jpg}
\end{center}
\textit{图2.1.43(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_44_1.jpg}
\end{center}
\textit{图2.1.44}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_44_2.jpg}
\end{center}
\textit{图2.1.44(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_45.jpg}
\end{center}
\textit{图2.1.45}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_46_1.jpg}
\end{center}
\textit{图2.1.46(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_1_46_2.jpg}
\end{center}
\textit{图2.1.46(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_2.jpg}
\end{center}
\textit{图2.2.2}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_3_1.jpg}
\end{center}
\textit{图2.2.3}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_3_2.jpg}
\end{center}
\textit{图2.2.3(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_6.jpg}
\end{center}
\textit{图2.2.6}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_7.jpg}
\end{center}
\textit{图2.2.7}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_8.jpg}
\end{center}
\textit{图2.2.8}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_11_1.jpg}
\end{center}
\textit{图2.2.11(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_11_2.jpg}
\end{center}
\textit{图2.2.11(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_12_1.jpg}
\end{center}
\textit{图2.2.12(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_12_2.jpg}
\end{center}
\textit{图2.2.12(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_13_1.jpg}
\end{center}
\textit{图 2.2.13}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_13_2.jpg}
\end{center}
\textit{图2.2.13}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_14.jpg}
\end{center}
\textit{图2.2.14}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_15.jpg}
\end{center}
\textit{图2.2.15}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_17.jpg}
\end{center}
\textit{图2.2.17}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_18.jpg}
\end{center}
\textit{图2.2.18}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_19_1.jpg}
\end{center}
\textit{图2.2.19}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_19_2.jpg}
\end{center}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_19_3.jpg}
\end{center}
\textit{图 2.2.19(3)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_20.jpg}
\end{center}
\textit{图2.2.20}
...
\newpage
\textbf{2.2.21.} 在有介质时,高斯定理为 $\oiint_{S} D \cdot dS = Q$ , 式中 Q 是高斯面 S 内自由电荷量的代数和. 如果把介质都去掉, 而让自由电荷的分布和数量都保持原样, 这时便有 $\varepsilon_0\oiint_{S}\vec{E}_0\cdot \mathrm{d}\vec{S} = Q.$ (1)有人据此得出结论： $\vec{D}$ 只由自由电荷决定，而与介
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_21_1.jpg}
\end{center}
\textit{图2.2.21(3)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_21_2.jpg}
\end{center}
\textit{图2.2.21}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_21_3.jpg}
\end{center}
\textit{图2.2.21(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_21_4.jpg}
\end{center}
\textit{图2.2.21(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_26.jpg}
\end{center}
\textit{图2.2.26}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_31.jpg}
\end{center}
\textit{图2.2.31}
...
\newpage
\textbf{2.2.33.} 半径为 $R$ 、电容率为 $\varepsilon$ 的均匀介质球中心，放有电荷量为 $Q$ 的点电荷，球外是空气。（1)试求球内外的电场强度 $\vec{E}$ 和电势 $U$ ；（2）如果要使球外的电场强度为零而球内的电场强度不变，则球面上应放的电荷量为多少？这电荷量如何分布？
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_35.jpg}
\end{center}
\textit{图2.2.35}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_36.jpg}
\end{center}
\textit{图2.2.36}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_2_41.jpg}
\end{center}
\textit{图2.2.41}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_1_1.jpg}
\end{center}
\textit{图2.3.1}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_1_2.jpg}
\end{center}
...
\textbf{2.3.4.} 电容器由三片面积都是 $6.0 \, cm^{2}$ 的锡箔构成，相邻两箔间的距离都是 0.10 mm，外边两片联在一起成为一极，中间一片作为另一极，如图
 所示. 略去边缘效应. (1) 试求电容 C; (2) 若在这电容器两极加上 220 伏的

电压,问三箔上电荷量的面密度各是多少?

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_4.jpg}
\end{center}
\textit{图2.3.4}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_5.jpg}
\end{center}
\textit{图2.3.5}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_6.jpg}
\end{center}
\textit{图2.3.6}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_7.jpg}
\end{center}
\textit{图2.3.7}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_8.jpg}
\end{center}
\textit{图2.3.8}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_11.jpg}
\end{center}
\textit{图2.3.11}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_12.jpg}
\end{center}
\textit{图2.3.12}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_13.jpg}
\end{center}
\textit{图2.3.13}
...
\textbf{2.3.15.} 一平行板电容器两极板的面积都是 $2.0\mathrm{m}^2$ ，相距为 $5.0\mathrm{mm}$ 。当两板之间是空气时，加上一万伏电压后，断开电源，再在其间插入两平行介质层，一层介电常数为5.0，厚为 $2.0\mathrm{mm}$ ；另一层介电常数为2.0，厚为 $3.0\mathrm{mm}$ 。略去边缘效应。试求：(1)介质中 $\vec{E}$ 和 $\vec{D}$ 的值；(2)两极板的电势差 $U$ ；(3)电容 $C$
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_16.jpg}
\end{center}
\textit{图2.3.16}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_17.jpg}
\end{center}
\textit{图2.3.17}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_18.jpg}
\end{center}
\textit{图2.3.18}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_19_1.jpg}
\end{center}
\textit{图2.3.19}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_19_2.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_23.jpg}
\end{center}
\textit{图2.3.23}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_24.jpg}
\end{center}
\textit{图2.3.24}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_25.jpg}
\end{center}
\textit{图2.3.25}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_27.jpg}
\end{center}
\textit{图2.3.27}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_28_1.jpg}
\end{center}
\textit{图2.3.28}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_28_2.jpg}
\end{center}
\textit{图 2.3.28}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_29.jpg}
\end{center}
\textit{图2.3.29}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_30.jpg}
\end{center}
\textit{图2.3.30}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_31.jpg}
\end{center}
\textit{图2.3.31(1)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_32.jpg}
\end{center}
\textit{图2.3.32}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_33.jpg}
\end{center}
\textit{图2.3.33}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_35.jpg}
\end{center}
\textit{图2.3.35}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_37.jpg}
\end{center}
\textit{图 2.3.37}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_38_1.jpg}
\end{center}
\textit{图2.3.38}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_38_2.jpg}
\end{center}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_39.jpg}
\end{center}
\textit{图2.3.39}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_40.jpg}
\end{center}
\textit{图2.3.40}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_42.jpg}
\end{center}
\textit{图2.3.42}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_43_1.jpg}
\end{center}
\textit{图2.3.43(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_43_2.jpg}
\end{center}
\textit{图2.3.43(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_45.jpg}
\end{center}
\textit{图2.3.45}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_46.jpg}
\end{center}
\textit{图2.3.46}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_47.jpg}
\end{center}
\textit{图2.3.47}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_48.jpg}
\end{center}
\textit{图2.3.48}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_50.jpg}
\end{center}
\textit{图2.3.50}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_53.jpg}
\end{center}
\textit{图2.3.53}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_54.jpg}
\end{center}
\textit{图2.3.54}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_59.jpg}
\end{center}
\textit{图2.3.59}
...
\newpage
\textbf{2.3.60.} 一空气平行板电容器两极板的面积都是 S，相距为 d，电容便为 C=$\frac{\varepsilon_0S}{d}$ 当在两极板加上电压 $U$ 时，略去边缘效应，两极板间电场强度 $\vec{E}$ 的大小便为 $E = U / d$ 其中一板上的电荷量为 $Q = CU$ ，故它所受的力的大小为
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_63.jpg}
\end{center}
\textit{图2.3.63}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_67.jpg}
\end{center}
\textit{图2.3.67}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_68.jpg}
\end{center}
\textit{图2.3.68}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_2_3_72.jpg}
\end{center}
\textit{图 2.3.72}
