...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_1_1.jpg}
\end{center}
\textit{图9.1}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_1_2.jpg}
\end{center}
\textit{图9.1}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_5.jpg}
\end{center}
\textit{图9.5}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_6.jpg}
\end{center}
\textit{图9.6}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_9.jpg}
\end{center}
\textit{图9.9}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_13.jpg}
\end{center}
\textit{图9.13}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_17_1.jpg}
\end{center}
\textit{图9.17}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_17_2.jpg}
\end{center}
\textit{图 9.17(3)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_19_1.jpg}
\end{center}
\textit{图9.19(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_19_2.jpg}
\end{center}
\textit{图9.19(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_20_1.jpg}
\end{center}
\textit{图9.20(1)}

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_20_2.jpg}
\end{center}
\textit{图9.20(2)}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_21.jpg}
\end{center}
\textit{图 9.21}
...
\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_22.jpg}
\end{center}
\textit{图9.22}
...
\textbf{9.28.} 设一带电粒子是半径为 $R$ 的圆球, 所带的电荷量 $q$ 均匀地分布在球面上. 当这粒子以匀速 $\vec{v}(v \ll c)$ 运动时, 在它外面的空间里离球心 $O$ 为 $\vec{r}$ (图9.28) 处产生的磁场强度为

$$
\vec{H} = \frac {q \vec{v} \times \vec{r}}{4 \pi r ^ {3}}
$$

试求这磁场的总能量.

\begin{center}
    \includegraphics[width=0.3\linewidth,height=0.6\textheight,keepaspectratio]{figures/fig_9_28.jpg}
\end{center}
\textit{图9.28}
