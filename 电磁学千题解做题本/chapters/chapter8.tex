...
$$
\begin{array}{r l} \mathcal {E} & = \int_ {0} ^ {R} \boldsymbol {E} _ {i} \cdot \mathrm{d} \boldsymbol {l} = \int_ {0} ^ {R} \boldsymbol {v} \times \boldsymbol {B} \cdot \mathrm{d} \boldsymbol {l} = \int_ {0} ^ {R} v B \mathrm{d} l \\ & = \int_ {0} ^ {R} \omega l B \mathrm{d} l = \frac {1}{2} B \omega R ^ {2} = \frac {1}{2} B \cdot 2 \pi N \cdot R ^ {2} = N \pi B R ^ {2} \end{array} 
$$
