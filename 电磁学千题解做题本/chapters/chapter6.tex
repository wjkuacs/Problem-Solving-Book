...
\textbf{6.2.22.} 一个水平放置的铅丝圆环，直径为 $d = 10\mathrm{cm}$ ，铅丝的横截面积为 $S = 0.70\mathrm{mm}^2$ ，当环中载有 $I = 7.0\mathrm{A}$ 的电流时，环的温度因此升高到接近熔化的温度，这时铅的断裂强度为 $p_0 = 0.20\mathrm{kgf}\cdot /\mathrm{mm}^2$ 。如果加上均匀的外磁场，磁场强度 $\pmb{H}$ 的方向平行于圆环的轴线并沿电流 $I$ 的右旋进方向， $\pmb{H}$ 的大小为 $H = 10000\mathrm{Oe}$ ，试问这环会不会断裂？
