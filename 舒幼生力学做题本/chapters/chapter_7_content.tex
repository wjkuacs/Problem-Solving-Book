...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_7.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_7.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_8.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_8.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_9.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_9.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_10.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_10.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_11.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_11.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_13.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_13.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_15.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_15.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图_7_17.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig_7_17.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图_7_18.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig_7_18.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_19.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_19.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_20.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_20.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_21.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_21.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\textbf{7-25} 冰的密度记为 $\rho_{1}$ ，海水密度记为 $\rho_{2}$ ，有 $\rho_{1}<\rho_{2}$ 。金字塔形（正四棱锥形）的冰山漂浮在海水中，平衡时塔顶离水面高度为 $h$，试求冰山在平衡位置附近作竖直方向小振动的周期 $T$。
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_22.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_22.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图_7_23.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig_7_23.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_24.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_24.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_28.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_28.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图_7_30.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig_7_30.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_31.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_31.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_32.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_32.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_34.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_34.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图_7_35.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig_7_35.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图_7_39.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig_7_39.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_41.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_41.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_42.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_42.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_44.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_44.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_46.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_46.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_48.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_48.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_49.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_49.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图_7_51.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig_7_51.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_53.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_53.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图_7_54.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig_7_54.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.27\textwidth]{figures/图7_55.jpg} &
\resizebox{0.27\textwidth}{!}{\input{tikzfigs/chapter7/fig7_55.tex}} \\[2pt]
{\scriptsize 原图} & {\scriptsize TikZ 重绘}
\end{tabular}
\end{center}
